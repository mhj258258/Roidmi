...
U16		uiBatStatus;      //电池保护的状态位
U16		uiVCell[20];//电芯的电压值（每节）
U16		ulVoltage;//总的电压值
S32		slCurr;
U16		uiTemp1;
U16		uiTemp2;
U16		uiICTemp1;//ic内部温度
U16		uiICTemp2;
U32		ulFCC;		//系统满充容量							
U32		ulRC;     //剩余电量
U16		uiRSOC;   //电量百分比
...
//by tomi
extern U8 xdata	ConectFlg_poron_prev;
extern U8 xdata LoadConnet_FLG;
extern U8 xdata ConectFlg_poron;
extern U8 xdata charge_detect_cnt;
extern U8 xdata packfault_cnt;
extern U8 xdata packfault_i;
extern U8 xdata fault_cntoiv;
