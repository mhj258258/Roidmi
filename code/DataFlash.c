...
//充电参数区开始 SubClassID=0x02		langth=18			
	...
	0x010,0x004,						//0x010,0x036,						// U16 xdata OVRvol         	_at_ 	CHG_PARA_MAP_ADDR+2;	4150 --->4100
...
//充电温度保护参数开始 SubClassID=0x05	langth=11
	0x00C,0x08B,//0x00C,0x09F,						// U16 xdata TempOTC      		_at_ 	CHG_TEMP_PARA_MAP_ADDR;		3231-2731=500 --->480+2731=3221
	0x00C,0x063,//0x00C,0x06D,						// U16 xdata TempOTCR      		_at_ 	CHG_TEMP_PARA_MAP_ADDR+2;	3181-2731=450  440+2731 =3181
	0x00A,0x083,//0x00A,0x0AB,						// U16 xdata TempUTC        	_at_ 	CHG_TEMP_PARA_MAP_ADDR+4;	2731 -40 =2691
	0x00A,0x0B5,//0x00A,0x0DD,						// U16 xdata TempUTCR       	_at_ 	CHG_TEMP_PARA_MAP_ADDR+6;	2781-2731=50, 2731 + 10 =2741
...
//放电温度保护参数开始 SubClassID=0x06	langth=9
	0x00D,0x085,//0x00D,0x067,	// U16 xdata TempOTD       	 	_at_ 	DSG_TEMP_PARA_MAP_ADDR;		3431-2731=700 --->730+2731=3461
	0x00C,0x0EF,//0x00C,0x0D1,	// U16 xdata TempOTDR       	_at_ 	DSG_TEMP_PARA_MAP_ADDR+2;	3281-2731=550 --->580+2731=3311
...
//充电温度保护参数开始 SubClassID=0x05	langth=11
	...
	0x010,0x004,//0x00C,0x06D,						// U16 xdata TempOTCR      		_at_ 	CHG_TEMP_PARA_MAP_ADDR+2;	3181-2731=450
